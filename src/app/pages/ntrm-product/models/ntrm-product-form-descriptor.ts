...
/**
 * Ntrm product test form definition
 */

export type NtrmProductForm = RequestNtrmProductTestEntry & { entryTime: Date }

export const ntrmProductDetailsFormControlDescriptor = new Map<keyof NtrmProductForm, FormControlValueDescriptor<unknown, unknown>>([
