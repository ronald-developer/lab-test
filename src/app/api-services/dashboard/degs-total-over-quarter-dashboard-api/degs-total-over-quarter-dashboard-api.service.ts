...
import { PostSearchDegsTotalOverQuarterDashboardRequest } from './requests/post-search-degs-dry-total-over-quarter-dashboard-request';
import { PostSearchDegsDryTotalOverQuarterDashboardResponse } from './responses/post-search-degs-dry-total-over-quarter-dashboard-response';


@Injectable({
	providedIn: 'root'
})
export class DegsTotalOverQuarterDashboardApiService {
